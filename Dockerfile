...
# Install node and R
RUN apt-get update \
    && apt-get install -y curl git libsqlite3-dev libxml2-dev libssl-dev libcurl4-openssl-dev libffi-dev libyaml-dev libreadline-dev zlib1g-dev \
...
# Build the js front-end and precompile assets
RUN rake degust:build \
