...
def embed(csv, args):
  ...
  <head profile="http://www.w3.org/2005/10/profile">
    ...
    <!-- Externals CSS -->
    <link rel="stylesheet" href='http://drpowell.github.io/degust/dist/latest/css/lib.css' />

    <link rel="stylesheet" href='http://drpowell.github.io/degust/dist/latest/css/common.css' type="text/css" />
    <link rel="stylesheet" href='http://drpowell.github.io/degust/dist/latest/css/compare.css' type="text/css "/>

    <script type="text/javascript" src='http://drpowell.github.io/degust/dist/latest/common.js'></script>
    <script type="text/javascript" src='http://drpowell.github.io/degust/dist/latest/slickgrid.js'></script>
    <script type="text/javascript" src='http://drpowell.github.io/degust/dist/latest/compare.js'></script>
  </head>
  <body>
    <div id="replace-me" class="container">
      <div class="jumbotron">
        ...
        <img src='http://drpowell.github.io/degust/dist/latest/images/front-loader.gif'>
      </div>
    </div>
    ...
    #print columns
    settings = ["html_version: '1.0'",
                "asset_base: 'http://drpowell.github.io/degust/dist/latest/'",
                "csv_data: data", 
